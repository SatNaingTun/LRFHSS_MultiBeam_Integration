...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stepper-output-csv", type=Path, default=None, help="Default: <output-dir>/satellite_steps.csv")
    parser.add_argument(
...
def main() -> int:
    ...
    # Requested mapping:
    #   stepper nodes   -> node_points
    #   stepper demods  -> num_decoders
    node_points = max(1, int(requested_nodes))
